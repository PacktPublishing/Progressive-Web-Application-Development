var app = (function() {
  var indexPage = function() {
    // Firebase URL for fetch
    var FIREBASE_GET_URL = 'https://pwanotes-312sds.firebaseio.com/notes.json';
    var FIREBASE_POST_URL = 'https://pwanotes-312sds.firebaseio.com/saveNote';
    ...
    var getDataAndUpdateUI = function() {
      ...
      db_helpers.readAllNote().then(function(data) {
    ...
    var deleteNote = function(id) {
      db_helpers.deleteNote(id).then(function() {
        getDataAndUpdateUI();
    ...
    getDataAndUpdateUI();
    // to mock a latency while recieving data from server
    //  setTimeout(function() {
    //    getDataAndUpdateUI();
    //  }, 3000);
  ...
  var addPage = function() {
    ...
    var AttachSubmitForm = function(data) {
      ...
      addNoteForm.addEventListener('submit', function(event) {
        ...
        db_helpers.writeNote(noteData).then(function() {
          helpers.showMessage('successfully updated to local db!');
          setTimeout(function() {
            helpers.showMessage(
              noteData.id + ' has been successfully synced with server!'
            );
          }, 3000);
        });
      });
